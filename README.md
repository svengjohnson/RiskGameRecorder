...
- The territory against a which roll completely failed (lost 0).
- There's no distinction between a blitz and a slow roll, if <3 lost/killed

## User Interface

<img width="342" height="455" alt="image" src="https://github.com/user-attachments/assets/fc65c6a9-43fb-415e-b6f7-2501a54c80dc" />

## Reading the recording file

[Example Recording JSON](https://github.com/svengjohnson/RiskGameRecorder/blob/main/2026-03-09--03-40-Alcatraz-CapitalConquest-Exponential-v1.json)

While I haven't created a tool for replaying these just yet, just paste it in your favourite JSON viewer, like [https://jsoneditoronline.org](https://jsoneditoronline.org)
...
"players": {
  "1": {
    ...
    "rank1v1": "Gold",
    "battlePoints": 189450,
    "isBotted": false // true for players that started as bots
  },
  "2": {
    "lobbyIndex": 5,
    "userId": 54535920,
